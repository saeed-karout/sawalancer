...
import { newsletterService } from '../api/client'
...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: 'https://instagram.com/sawalancer',
    ...
    },
    {
      ...
      href: 'https://linkedin.com/company/sawalancer',
    ...
    },
    {
      ...
      href: 'https://twitter.com/sawalancer',
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16 ${isRTL ? 'rtl' : ''}`}>
          ...
          <div className={`lg:col-span-2 `}>
            <Link to="/" className={`flex items-start  mb-6 `}>
              ...
              <img src="/icons/Sawalancer logo brand-14.png" width={350} alt="logo icon" />
            </Link>
            ...
            <div className={`flex gap-2 ${isRTL ? 'flex-row-reverse' : ''}`}>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-12 h-12 rounded-full bg-gradient-to-r from-cosmic-saturated to-cosmic-dark flex items-center justify-center hover:shadow-lg hover:shadow-cosmic-saturated/30 transition-all disabled:opacity-50"
              >
                {isSubscribing ? (
                  <motion.div
                    animate={{ rotate: 360 }}
              ...
              {newsletterStatus && (
                <motion.span
                  ...
                  exit={{ opacity: 0 }}
                  className={`absolute right-0 text-xs ${newsletterStatus === 'success' ? 'text-green-400' : 'text-red-400'}`}
                >
                  {newsletterStatus === 'success' ? t('footer.subscribeSuccess') : t('footer.subscribeError')}
                </motion.span>
              )}
            </div>
          </div>
